...
from tools.builtin import edit_file, glob, grep, list_dir, read_file, shell, write_file  # noqa: F401  (registration side effect)
...
def get_all_builtin_tools() -> list[type]:  # legacy class-based tools still to be converted
    return [WebSearchTool, WebFetchTool, TodosTool, MemoryTool]
